...
from L1Trigger.HGCalTPGStandalone.l1tHGCalVFEProducer_cfi import vfe_proc
...
l1tHGCalConcentratorProducerSL = cms.EDProducer(
    "HGCalConcentratorProducer",
    InputTriggerCells = cms.InputTag('l1tHGCalVFEProducerSL:HGCalROCProcessor'),
    InputTriggerSums = cms.InputTag('l1tHGCalVFEProducerSL:HGCalROCProcessor'),
    ProcessorParameters = threshold_conc_proc.clone()
    )

l1tHGCalConcentratorProducerHFNoseSL = l1tHGCalConcentratorProducerSL.clone(
    InputTriggerCells = cms.InputTag('l1tHFnoseVFEProducerSL:HGCalROCProcessor'),
    InputTriggerSums = cms.InputTag('l1tHFnoseVFEProducerSL:HGCalROCProcessor')
)
