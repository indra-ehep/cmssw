...
l1tHGCalBackEndLayer1ProducerSL = cms.EDProducer(
    "HGCalBackendLayer1Producer",
    InputTriggerCells = cms.InputTag('l1tHGCalConcentratorProducerSL:HGCalConcentratorProcessorSelection'),
    BypassBackendMapping = cms.bool(True),
    ProcessorParameters = clustering2d_proc.clone()
    )

l1tHGCalBackEndLayer1ProducerHFNoseSL = l1tHGCalBackEndLayer1ProducerSL.clone(
    InputTriggerCells = 'l1tHGCalConcentratorProducerHFNoseSL:HGCalConcentratorProcessorSelection'
)
