...
ntuple_triggercells = cms.PSet(
    ...
    TriggerCells = cms.InputTag('l1tHGCalConcentratorProducerSL:HGCalConcentratorProcessorSelection'),
...
ntuple_triggersums = cms.PSet(
    ...
    TriggerSums = cms.InputTag('l1tHGCalConcentratorProducerSL:HGCalConcentratorProcessorSelection'),
)

ntuple_econdata = cms.PSet(
    NtupleName = cms.string('HGCalTriggerNtupleHGCConcentratorData'),
    ConcentratorData = cms.InputTag('l1tHGCalConcentratorProducerSL:HGCalConcentratorProcessorSelection'),
)
...
l1tHGCalTriggerNtuplizerSL = cms.EDAnalyzer(
