...
from L1Trigger.HGCalTPGStandalone.hgcalVFE_cff import *
from L1Trigger.HGCalTPGStandalone.hgcalConcentrator_cff import *
from L1Trigger.HGCalTPGStandalone.hgcalBackEndLayer1_cff import *
from L1Trigger.L1THGCal.hgcalBackEndLayer2_cff import *
from L1Trigger.HGCalTPGStandalone.hgcalTowerMap_cff import *
from L1Trigger.L1THGCal.hgcalTower_cff import *

L1THGCalTriggerPrimitivesTask = cms.Task(L1THGCalVFESL, L1THGCalConcentratorSL, L1THGCalBackEndLayer1, L1THGCalBackEndLayer2, L1THGCalTowerMap, L1THGCalTower)
...
_hfnose_hgcalTriggerPrimitivesTask.add(L1THFnoseVFESL, L1THGCalConcentratorHFNoseSL, L1THGCalBackEndLayer1HFNose, L1THGCalBackEndLayer2HFNose, L1THGCalTowerMapHFNose, L1THGCalTowerHFNose)
