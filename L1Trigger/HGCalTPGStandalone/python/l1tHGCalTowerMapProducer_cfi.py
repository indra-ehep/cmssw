...
l1tHGCalTowerMapProducerSL = cms.EDProducer(
    "HGCalTowerMapProducer",
    InputTriggerSums = cms.InputTag('l1tHGCalConcentratorProducerSL:HGCalConcentratorProcessorSelection'),
...
l1tHGCalTowerMapProducerHFNoseSL = l1tHGCalTowerMapProducerSL.clone(
    InputTriggerSums = cms.InputTag('l1tHGCalConcentratorProducerHFNoseSL:HGCalConcentratorProcessorSelection'),
